...
tool_list <- list(
  ...
  export_1 = paste0(
    "<tool library='io_gdal' tool='2' name='Export GeoTIFF'>
        ...
        <option id='FILE'>", file.path(covariate_file_path, "1m", "dem.tif"), "</option>
      </tool>"
  ), 
  export_2 = paste0(
    "<tool library='io_gdal' tool='2' name='Export GeoTIFF'>
        <input id='GRIDS'>chm_out</input>
        <option id='FILE'>", file.path(covariate_file_path, "1m", "chm.tif"), "</option>
      </tool>"
  ),
  footer = paste0(
    "</tools>
...
lidar <- try(stack(file.path(covariate_file_path, "1m", "dem.tif"), 
                   file.path(covariate_file_path, "1m", "chm.tif")))
