...
old_pto <- file.path(AOI_dir, "1_map_inputs", "field_data", "processed_2019")
pto <- file.path(AOI_dir, "1_map_inputs", "field_data", "processed_2020")
...
# Load the polygons and associated observations. The polygons are unchanged from 2019
